...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-20 sm:py-32 bg-card/30 backdrop-blur">
        ...
        >
          ...
          <div className="relative rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/5 to-secondary/5 p-8 sm:p-12 shadow-lg shadow-primary/20">
            ...
            >
              ...
              {/* Content */}
              <p className="text-xl text-foreground italic leading-relaxed">{currentTestimonial.content}</p>
