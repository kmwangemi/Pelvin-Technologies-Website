...
const steps = [
  {
    number: 1,
    title: 'Discovery',
    description: 'We understand your business, goals, and challenges through detailed consultation.',
  },
  {
    number: 2,
    title: 'Strategy',
    description: 'We create a comprehensive roadmap tailored to your specific needs and timeline.',
  },
  {
    number: 3,
    title: 'Design',
    description: 'Our designers craft beautiful, user-centric interfaces and experiences.',
  },
  {
    number: 4,
    title: 'Development',
  ...
  },
  {
    number: 5,
    title: 'Testing',
    description: 'Rigorous QA testing ensures quality, performance, and security standards are met.',
  },
  {
    number: 6,
    title: 'Launch',
    description: 'We deploy your solution and provide ongoing support for seamless operation.',
  },
]
