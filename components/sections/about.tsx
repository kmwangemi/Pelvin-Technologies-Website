...
const highlights = [
	{
		...
		title: "Expert Team",
		description:
			"Experienced developers, designers, and strategists dedicated to your success",
	},
	{
		icon: Zap,
		title: "Cutting Edge",
		description:
			"Latest technologies and best practices to deliver modern solutions",
	},
	{
		icon: Target,
		title: "Results Driven",
		description:
			"Focused on delivering measurable outcomes that impact your business",
	},
	{
		icon: Globe,
		title: "Global Reach",
		description:
			"Serving clients worldwide with round-the-clock support and expertise",
	},
];
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-lg text-muted-foreground max-w-3xl mx-auto text-balance">
						Since our founding, PELVIN Technologies has been at the forefront of
						software innovation, helping businesses unlock their potential
					...
					>
						<div>
							...
							<p className="text-muted-foreground leading-relaxed">
								PELVIN Technologies is a leading software development company
								specializing in creating innovative, scalable solutions that
								drive business growth. Our team of talented professionals
						...
						<div>
							...
							<p className="text-muted-foreground leading-relaxed">
								We believe in collaborative partnerships where your success is
								our success. By understanding your unique challenges and goals,
								we develop customized strategies and solutions that deliver
