...
import { Brain, Cloud, Code, Lock, Smartphone, Zap } from "lucide-react";
...
const services = [
	...
	},
	{
		...
		description:
			"Scalable cloud infrastructure and deployment on AWS, GCP, and Azure.",
	},
	{
		icon: Brain,
		title: "AI Integration",
		description:
			"Intelligent automation using machine learning and AI technologies.",
	},
	{
		icon: Zap,
		title: "Performance",
