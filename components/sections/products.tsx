...
const products = [
  {
    ...
    description: 'All-in-one platform for churches to manage members, events, giving, and communications.',
    features: [
  ...
  },
  {
    ...
    description: 'Build stronger connections with your congregation through digital community features.',
    features: [
      'Group Management',
