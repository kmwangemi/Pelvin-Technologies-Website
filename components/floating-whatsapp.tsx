  ...
  return (
    <div className="fixed bottom-24 right-8 z-30">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 px-6 py-4">
              ...
              <p className="text-green-100 text-sm">We usually reply within minutes</p>
            </div>

            {/* Content */}
            <div className="p-6 space-y-4">
              <p className="text-sm text-muted-foreground">
                Hi! Have questions about our services? Chat with us directly on WhatsApp.
              </p>
              <a
                href="https://wa.me/254712345678?text=Hello%20PELVIN%20Technologies%2C%20I%20would%20like%20to%20inquire%20about%20your%20services"
                target="_blank"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center text-white group"
      >
        <AnimatePresence>
          {isOpen ? (
            <motion.div
